        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3 hero-cta-group">
                    @guest
                        <a href="{{ route('register', ['role' => 'organizer']) }}" class="btn ph-btn-primary btn-lg hero-cta-primary">Find Performers</a>
                        <a href="{{ route('register', ['role' => 'performer']) }}" class="btn btn-lg hero-join-btn">Join as Performer</a>
                    @else
