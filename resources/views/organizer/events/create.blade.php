...
<div class="container organizer-event-form">
    ...
    <div class="ph-card p-4 p-lg-5">
        <form method="POST" action="{{ route('organizer.events.store') }}" enctype="multipart/form-data">
            ...
            <div class="organizer-form-section mb-4">
                <h5>Event Details</h5>
                <p class="organizer-form-help">Add the basic information and performer categories needed for this event.</p>
...
>>>>>>> ce6581d476821261bb96f5287d365f5c4b614b08
                    </div>
            ...
            <div class="organizer-form-section organizer-compensation-section">
                <h5>Compensation Details</h5>
                <p class="organizer-form-help">This section will show prizes, an hourly rate, or a fixed budget after the event type is configured.</p>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top"><a href="{{ route('organizer.events.index') }}" class="btn ph-btn-secondary">Cancel</a>
