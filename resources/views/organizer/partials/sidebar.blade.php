<a href="{{ route('organizer.profile.show') }}" class="sidebar-profile-block d-block text-center text-decoration-none mb-4">
    ...
    <div class="sidebar-profile-name"> Hello, <br>{{ auth()->user()->name }}!</div>
...
<nav class="nav flex-column">
    ...
    <a class="nav-link {{ request()->routeIs('organizer.bookings.*') ? 'active' : '' }}" href="{{ route('organizer.bookings.index') }}"><i class="fas fa-handshake me-2"></i> Bookings</a>
