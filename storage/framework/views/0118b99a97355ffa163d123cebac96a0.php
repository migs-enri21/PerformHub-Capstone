...
<nav class="nav flex-column">
    ...
    <a class="nav-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.categories.index')); ?>"><i class="fas fa-tags me-2"></i> Categories</a>
...
<?php /**PATH D:\GitHub\PerformHub-Capstone\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>