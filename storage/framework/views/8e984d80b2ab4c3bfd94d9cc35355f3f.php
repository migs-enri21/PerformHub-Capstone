    ...
    <div class="auth-form-panel">
        <div class="w-100" style="max-width: 440px; margin: 0 auto;">
            ...
            <?php if(session('warning')): ?>
                <div class="alert alert-warning py-2"><?php echo e(session('warning')); ?></div>
            <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control ph-input" placeholder="you@example.com" value="<?php echo e(old('email')); ?>" required>
                </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Erico\Documents\PerformHub-Capstone\resources\views\auth\login.blade.php ENDPATH**/ ?>