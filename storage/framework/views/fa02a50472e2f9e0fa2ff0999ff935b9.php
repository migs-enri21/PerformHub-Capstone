...
<div class="mb-4">
    ...
    <a href="<?php echo e(route('organizer.events.index')); ?>" class="btn btn-sm me-2 <?php echo e(! $selectedFilter ? 'btn-primary' : 'btn-outline-primary'); ?>">All</a>
    <a href="<?php echo e(route('organizer.events.index', ['status' => 'upcoming'])); ?>" class="btn btn-sm me-2 <?php echo e($selectedFilter === 'upcoming' ? 'btn-primary' : 'btn-outline-secondary'); ?>">Upcoming</a>
    <a href="<?php echo e(route('organizer.events.index', ['status' => 'ongoing'])); ?>" class="btn btn-sm me-2 <?php echo e($selectedFilter === 'ongoing' ? 'btn-primary' : 'btn-outline-secondary'); ?>">Ongoing</a>
    <a href="<?php echo e(route('organizer.events.index', ['status' => 'completed'])); ?>" class="btn btn-sm me-2 <?php echo e($selectedFilter === 'completed' ? 'btn-primary' : 'btn-outline-secondary'); ?>">Completed</a>
    <a href="<?php echo e(route('organizer.events.index', ['status' => 'cancelled'])); ?>" class="btn btn-sm <?php echo e($selectedFilter === 'cancelled' ? 'btn-primary' : 'btn-outline-secondary'); ?>">Cancelled</a>
</div>
        ...
        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-6">
                <div class="ph-card organizer-event-card h-100 overflow-hidden">
                    ...
                    <div class="p-3">
                        <h5 class="event-card-title mb-2"><?php echo e($event->title); ?></h5>
                        ...
                        <div class="mt-3 d-flex flex-wrap gap-2">
                            ...
                            <form method="POST" action="<?php echo e(route('organizer.events.destroy', $event)); ?>" class="delete-event-form">
                                <?php echo csrf_field(); ?>
