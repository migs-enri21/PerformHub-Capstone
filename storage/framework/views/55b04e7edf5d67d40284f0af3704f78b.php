...
<form method="POST" action="<?php echo e(route('onboarding.verification.store')); ?>" enctype="multipart/form-data">
    ...
    <?php if($user->isOrganizer()): ?>
        ...
        <div class="mb-3">
            ...
            <select name="government_id_type" id="government_id_type" class="form-select ph-input <?php $__errorArgs = ['government_id_type'];
...
unset($__errorArgs, $__bag); ?>" required>
                <option value="" disabled <?php echo e($governmentIdType === '' ? 'selected' : ''); ?>>Select Government ID Type</option>
                <?php $__currentLoopData = [
                    ...
                    <option value="<?php echo e($value); ?>" <?php echo e($governmentIdType === $value ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <?php $__errorArgs = ['government_id_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3" id="government_id_other_group" style="display: <?php echo e($governmentIdType === 'Other Government-Issued ID' ? 'block' : 'none'); ?>;">
            <label class="form-label text-muted small mb-2" for="government_id_other">Specify Other Government ID</label>
            <input type="text" name="government_id_other" id="government_id_other" class="form-control ph-input <?php $__errorArgs = ['government_id_other'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('government_id_other')); ?>" placeholder="Enter government ID type">
            <?php $__errorArgs = ['government_id_other'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
